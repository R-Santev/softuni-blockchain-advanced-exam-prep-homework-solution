...
contract Payroll is Initializable, EIP712Upgradeable {
    ...
    function initialize(
        ...
        __EIP712_init(
            string(abi.encodePacked("Payroll ", _departmentName)),
            "1"
        );
    ...
    function claimSalary(
        ...
        require(
            isValidSignature(employee, period, usdAmount, signature),
            InvalidSignature()
        );
    ...
    function isValidSignature(
        ...
        bytes32 structHash = keccak256(
            abi.encode(PAY_STUB_TYPE_HASH, employee, period, usdAmount)
        );
